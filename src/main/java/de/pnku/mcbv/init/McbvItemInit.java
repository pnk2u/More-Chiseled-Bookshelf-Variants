...
public class McbvItemInit {
    ...
    public static final BlockItem POPLAR_CHISELED_BOOKSHELF_I = itemFromBlock(POPLAR_CHISELED_BOOKSHELF);
    ...
    public static void registerItems() {
        ...
        registerItem(POPLAR_CHISELED_BOOKSHELF_I, PALE_OAK_CHISELED_BOOKSHELF_I);
        registerItem(MANGROVE_CHISELED_BOOKSHELF_I, POPLAR_CHISELED_BOOKSHELF_I);
